...
st.title("🥔 Potato Price & Weather Analysis")
st.markdown("Explore the relationship between Potato prices and weather conditions in Hoshiarpur.")

selected_vegetable = "Potato" # Hardcode for this page
...
if not df_selected_veg.empty:
    ...
    if len(available_years) >= 5:
        years_to_compare = available_years[-5:] # Get the last 5 available years
    else:
        years_to_compare = available_years # Get all available years
